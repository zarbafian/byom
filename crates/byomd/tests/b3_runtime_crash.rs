...
fn the_placement_admit_commit_point_survives_every_boundary() {
    for phase in PHASES {
        ...
        let request = json!({
            ...
            "resource_allocation_digest": ep.allocation_digest.clone(),
...
fn the_episode_claim_commit_point_survives_every_boundary() {
    for phase in PHASES {
        ...
        let request = json!({
            ...
            "context_manifest_digest": common::runtime::portable_digest(0xd2),
        ...
        for phase in PHASES {
            ...
            let mut request = match op {
                ...
                "checkpoint_commit" => json!({
                    ...
                    "checkpoint_digest": common::runtime::portable_digest(0xe1),
                }),
                "episode_yield" => json!({
